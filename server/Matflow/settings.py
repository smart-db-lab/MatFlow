...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Swagger / OpenAPI for my backend",
    "VERSION": "1.0.0",
    "SERVE_PUBLIC": True,
}
...
MIDDLEWARE = [
    ...
    "Matflow.debug_middleware.DebugMiddleware",
]
...
SESSION_COOKIE_SAMESITE = "Lax"   # same-origin dev; prevents cross-site drop
SESSION_COOKIE_SECURE = False      # keep False for HTTP dev; True in HTTPS prod
...
# Increase upload size limits for large dataset support - set to 200MB to handle very large datasets
...
# KAGGLE_KEY = os.environ.get("KAGGLE_KEY" , "b084d3671f79bb58183812035eab3864")