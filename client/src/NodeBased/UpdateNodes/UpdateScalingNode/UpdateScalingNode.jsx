...
import Scaling from "../../../FunctionBased/Functions/Feature Engineering/Scaling/Scaling";

function UpdateScalingNode({ visible, setVisible, csvData, nodeId }) {
  ...
  const handleSave = () => {
    const tempNode = {
      ...
      data: {
        ...nodeDetails.data,
        scaling: { ...data, dataset_name, file: csvData },
      },
    };
...
export default UpdateScalingNode;
