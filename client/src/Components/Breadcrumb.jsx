...
const functionTreeData = [
  ...
  },
  {
    ...
    children: [
      { id: '5-0', label: 'Split Dataset Test-Train' },
      { id: '5-1', label: 'Build Model' },
      { id: '5-2', label: 'Evaluate Model Performance' },
      { id: '5-3', label: 'Saved Models' },
      { id: '5-4', label: 'Compare Models' },
    ],
  },
  {
    id: '6',
...
const DATASET_LABEL_MAP = {
  ...
  'Feature Engineering': 'Manage Material Properties',
  'Data Prep': 'Manage Material Properties',
  ...
  'Generate Predictive Model': 'Generate Predictive Model',
  'Split Dataset': 'Split Dataset Test-Train',
  'Split Dataset Test-Train': 'Split Dataset Test-Train',
